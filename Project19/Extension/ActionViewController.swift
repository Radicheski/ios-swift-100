...
class ActionViewController: UIViewController {
    ...
    @IBAction func done() {
        ...
        let webDictioanry: NSDictionary = [NSExtensionJavaScriptFinalizeArgumentKey: argument]
        let customJavaScript = NSItemProvider(item: webDictioanry, typeIdentifier: kUTTypePropertyList as String)
